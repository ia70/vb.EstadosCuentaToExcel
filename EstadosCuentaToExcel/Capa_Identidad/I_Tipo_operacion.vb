Public Class I_Tipo_operacion
    ...
    Public Sub New(id As Integer, id_formato As String, cadena As String, cadena_adicional_1 As String, cadena_adicional_2 As String, cadena_no_contener As String, tipo As Integer)
        _id = id
